    ...
    >
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full group relative overflow-hidden bg-gradient-to-r from-purple-600 to-indigo-700 
                     hover:from-purple-700 hover:to-indigo-800 text-white font-semibold py-4 px-6 rounded-xl 
        ...
        >
          <div className="flex items-center justify-center space-x-3">
            ...
            <div className="text-left">
              <div className="text-lg font-semibold">HOD</div>
              <div className="text-sm opacity-90">Manage department, assign faculty and view analytics</div>
            </div>
          </div>
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -skew-x-12 
                          transform translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
