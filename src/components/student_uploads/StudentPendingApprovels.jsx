...
import { fetchAllApprovals, isDataStale } from "../../features/studentDashSlice";
...
const StudentPendingApprovels = () => {
  ...
  }, [dispatch, pendingApprovals.length, rejectedApprovals.length, approvedApprovals.length, approvalsLastFetched]);
